...
AIRLINE_SERVICES = {
    'MU':{'baggage':'2件×23kg','meal':'含餐'},
    'FM':{'baggage':'2件×23kg','meal':'含餐'},
    'CA':{'baggage':'2件×23kg','meal':'含餐'},
    'CZ':{'baggage':'2件×23kg','meal':'含餐'},
    'HO':{'baggage':'1件×20kg','meal':'含餐'},
    '9C':{'baggage':'无免费托运','meal':'无餐食'},
    '8L':{'baggage':'1件×20kg','meal':'含餐'},
    'NX':{'baggage':'1件×20kg','meal':'含餐'},
    'CX':{'baggage':'2件×23kg','meal':'含餐'},
    'KE':{'baggage':'2件×23kg','meal':'含餐'},
    'OZ':{'baggage':'2件×23kg','meal':'含餐'},
    'SQ':{'baggage':'1件×30kg','meal':'含餐'},
    'NH':{'baggage':'2件×23kg','meal':'含餐'},
    'GK':{'baggage':'无免费托运','meal':'无餐食'},
    'ZE':{'baggage':'无免费托运','meal':'无餐食'},
    'GJ':{'baggage':'1件×20kg','meal':'含餐'},
}
DEFAULT_SVC = {'baggage':'1件×20kg','meal':'含餐'}

AIRLINE_COLORS = {
    '东方航空':'#2980b9','上海航空':'#c0392b','中国国航':'#e74c3c',
    '南方航空':'#27ae60','海南航空':'#8e44ad','吉祥航空':'#e67e22',
    '春秋航空':'#f39c12','厦门航空':'#2c3e50','四川航空':'#16a085',
    '深圳航空':'#d35400','山东航空':'#3498db',
}
